    ...
    \new DrumStaff \with {
      ...
      \new DrumVoice {
        ...
        \drummode {
          \stemDown
          \voiceTwo
          bd4 hhp8 bd hhp4 bd | <bd hhp> r8 <bd hhp> r4 <bd hhp>
        }
        }>>
      }
    >>
    ...
    \new DrumStaff \with {
      ...
      \new DrumVoice {
        ...
        \drummode {
          ...
          \voiceOne
          \bar ".|:"
          cymr 4 <cymr ss>8 cymr4^> cymr8^>
          \tweak stencil #circle tommh
          <\tweak stencil #circle tommh cymr> |
         cymr4^> cymr8^> \tweak stencil #circle toml
          <\tweak stencil #circle toml cymr> cymr^>
          \tweak stencil #circle tommh
          <\tweak stencil #circle tommh cymr>
          \bar ":|."
        }
        ...
        \drummode {
          \stemDown
          \voiceTwo
          <bd hhp>4 r8 <bd hhp> r4 bd8 hhp | bd4 hhp8 bd hhp4 bd
        }
        }>>
      }
    >>
    ...
    \new DrumStaff \with {
      ...
      \new DrumVoice {
        ...
        \drummode {
          \stemDown
          \voiceTwo
          r4 hhp8 bd hhp4 bd | hhp4. <bd hhp>8 r4 bd8 hhp
        }
        }>>
      }
    >>
    ...
    \new DrumStaff \with {
      ...
      \new DrumVoice {
        ...
        \drummode {
          ...
          \voiceOne
          \bar ".|:"
          <\tweak stencil #circle tommh cymr>4^> cymr8^>
          \tweak stencil #circle tommh
          cymr cymr^> \tweak stencil #circle toml cymr |
          cymr4^> cymr8 cymr4^> cymr8^>
          \tweak stencil #circle toml cymr
          \bar ":|."
        }
        \new DrumVoice {
    ...
    \new DrumStaff \with {
      ...
      \new DrumVoice {
        ...
        \drummode {
          ...
          \voiceOne
          \bar ".|:"
          <cymr \tweak stencil #circle tommh>4^> cymr8 
          <cymr \tweak stencil #circle tommh>4^> cymr8^>
          \tweak stencil #circle toml cymr |
          cymr4^> cymr^> cymr8 cymr8^>
          \tweak stencil #circle toml cymr
          \bar ":|."
        }
        \new DrumVoice {
        \drummode {
          \stemDown
          \voiceTwo
          hhp4. <bd hhp>8 r4 bd8 hhp | r4 hhp8 bd hhp4 bd
        }
        }>>
      }
    >>
