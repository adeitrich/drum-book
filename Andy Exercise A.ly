  ...
  \score {
    \new DrumStaff \with {
      ...
      \new DrumVoice {
        \drummode {
          \stemUp
          sn16 16 <sn bd> <sn bd> sn <sn bd> <sn bd> sn <sn bd> <sn bd> sn sn
          \tweak stencil #circle toml32 \tweak stencil #circle tommh bd32 32
          \tweak stencil #circle toml32 \tweak stencil #circle tommh bd32 32
          \bar ":|."
        }
      }
  ...
  \score {
    \new DrumStaff \with {
      ...
      \new DrumVoice {
        \drummode {
          \stemUp
          sn16 <sn bd> <sn bd> sn <sn bd> <sn bd> sn <sn bd> <sn bd> sn <sn bd> sn
          \tweak stencil #circle toml32 \tweak stencil #circle tommh bd32 32
          \tweak stencil #circle toml32 \tweak stencil #circle tommh bd32 32
          \bar ":|."
        }
  ...
  \score {
    \new DrumStaff \with {
      ...
      \new DrumVoice {
        \drummode {
          \stemUp
          sn16_"R" <sn bd>_"L" <sn bd>_"R" sn_"L"
          \tuplet 6/4 {
            sn16_"R" <sn bd>_"L" <sn bd>_"R" sn16_"R" <sn bd>_"L" <sn bd>_"R"
          }
          sn16 <sn bd> <sn bd> sn
          \tuplet 6/4 {
            \tweak stencil #circle toml16_"R" <\tweak stencil #circle tommh bd>_"L"
            <sn bd>_"R"
            \tweak stencil #circle toml16_"R" <\tweak stencil #circle tommh bd>_"L"
            <sn bd>_"R"
          }
  ...
  \score {
    \new DrumStaff \with {
      ...
      \new DrumVoice {
        \drummode {
          \stemUp
          sn16_"R" <hh bd>_"L" <hh bd>_"R" sn_"L" <hh bd>_"R" <hh bd>_"L" sn_"R" <hh bd>_"L" <hh bd>_"R" sn_"L" <hh bd>_"R" <hh bd>_"L"
          sn32 sn bd bd sn32 sn bd bd
          \bar ":|."
        }
      }
    >>
